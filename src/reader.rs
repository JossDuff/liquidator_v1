...
impl Reader {
    pub fn new(
        ...
        let accounts: Arc<Mutex<Vec<Address>>> = Arc::new(Mutex::new(Vec::new()));
        Self {
            client,
            comptroller,
            liquidator,
