...
pub mod c_erc_20 {
    ...
    pub static CERC20_ABI: ::ethers::contract::Lazy<::ethers::core::abi::Abi> = ::ethers::contract::Lazy::new(
        __abi,
    );
    ...
    impl<M> ::core::fmt::Debug for CErc20<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(CErc20)).field(&self.address()).finish()
        }
    }
    ...
    impl ::ethers::core::abi::AbiDecode for CErc20Calls {
        fn decode(
            ...
            if let Ok(decoded)
                = <SetInterestRateModelCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
            ...
            if let Ok(decoded)
                = <AccrualBlockNumberCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
            ...
            if let Ok(decoded)
                = <BalanceOfUnderlyingCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
            ...
            if let Ok(decoded)
                = <BorrowBalanceCurrentCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::BorrowBalanceCurrent(decoded));
            }
            if let Ok(decoded)
                = <BorrowBalanceStoredCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::BorrowBalanceStored(decoded));
            }
            if let Ok(decoded)
                = <BorrowIndexCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::BorrowIndex(decoded));
            }
            if let Ok(decoded)
                = <BorrowRatePerBlockCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::BorrowRatePerBlock(decoded));
            }
            if let Ok(decoded)
                = <ComptrollerCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <ExchangeRateCurrentCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::ExchangeRateCurrent(decoded));
            }
            if let Ok(decoded)
                = <ExchangeRateStoredCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::ExchangeRateStored(decoded));
            }
            if let Ok(decoded)
                = <GetAccountSnapshotCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::GetAccountSnapshot(decoded));
            }
            if let Ok(decoded)
                = <GetCashCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::GetCash(decoded));
            }
            if let Ok(decoded)
                = <InitialExchangeRateMantissaCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::InitialExchangeRateMantissa(decoded));
            }
            if let Ok(decoded)
                = <InterestRateModelCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::InterestRateModel(decoded));
            }
            if let Ok(decoded)
                = <IsCTokenCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <RedeemUnderlyingCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::RedeemUnderlying(decoded));
            }
            if let Ok(decoded)
                = <RepayBorrowCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::RepayBorrow(decoded));
            }
            if let Ok(decoded)
                = <RepayBorrowBehalfCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::RepayBorrowBehalf(decoded));
            }
            if let Ok(decoded)
                = <ReserveFactorMantissaCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::ReserveFactorMantissa(decoded));
            }
            if let Ok(decoded)
                = <SeizeCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::Seize(decoded));
            }
            if let Ok(decoded)
                = <SupplyRatePerBlockCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
            ...
            if let Ok(decoded)
                = <TotalBorrowsCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::TotalBorrows(decoded));
            }
            if let Ok(decoded)
                = <TotalBorrowsCurrentCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::TotalBorrowsCurrent(decoded));
            }
            if let Ok(decoded)
                = <TotalReservesCall as ::ethers::core::abi::AbiDecode>::decode(data) {
