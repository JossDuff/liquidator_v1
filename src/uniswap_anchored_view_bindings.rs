...
pub mod uniswap_anchored_view {
    const _: () = {
        ::core::include_bytes!(
            "/home/joss/dev/liquidator_v1/abi/uniswapAnchoredView.json",
        );
    };
    #[allow(deprecated)]
    ...
    pub static UNISWAPANCHOREDVIEW_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    > = ::ethers::contract::Lazy::new(__abi);
    pub struct UniswapAnchoredView<M>(::ethers::contract::Contract<M>);
    impl<M> ::core::clone::Clone for UniswapAnchoredView<M> {
        fn clone(&self) -> Self {
            Self(::core::clone::Clone::clone(&self.0))
        }
    }
    impl<M> ::core::ops::Deref for UniswapAnchoredView<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for UniswapAnchoredView<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for UniswapAnchoredView<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(::core::stringify!(UniswapAnchoredView))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> UniswapAnchoredView<M> {
        ...
        pub fn events(
            ...
            ::std::sync::Arc<M>,
            M,
            UniswapAnchoredViewEvents,
        > {
            self.0.event_with_filter(::core::default::Default::default())
        }
    }
    impl<M: ::ethers::providers::Middleware> From<::ethers::contract::Contract<M>>
    for UniswapAnchoredView<M> {
    ...
    pub enum UniswapAnchoredViewEvents {
    ...
    impl ::ethers::contract::EthLogDecode for UniswapAnchoredViewEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = FailoverActivatedFilter::decode_log(log) {
                return Ok(UniswapAnchoredViewEvents::FailoverActivatedFilter(decoded));
            }
            if let Ok(decoded) = FailoverDeactivatedFilter::decode_log(log) {
                return Ok(UniswapAnchoredViewEvents::FailoverDeactivatedFilter(decoded));
            }
            if let Ok(decoded) = OwnershipTransferRequestedFilter::decode_log(log) {
                return Ok(
                    UniswapAnchoredViewEvents::OwnershipTransferRequestedFilter(decoded),
                );
            }
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(
                    UniswapAnchoredViewEvents::OwnershipTransferredFilter(decoded),
                );
            }
            if let Ok(decoded) = PriceGuardedFilter::decode_log(log) {
                return Ok(UniswapAnchoredViewEvents::PriceGuardedFilter(decoded));
            }
            if let Ok(decoded) = PriceUpdatedFilter::decode_log(log) {
                return Ok(UniswapAnchoredViewEvents::PriceUpdatedFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for UniswapAnchoredViewEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<FailoverActivatedFilter> for UniswapAnchoredViewEvents {
        fn from(value: FailoverActivatedFilter) -> Self {
            Self::FailoverActivatedFilter(value)
        }
    }
    impl ::core::convert::From<FailoverDeactivatedFilter> for UniswapAnchoredViewEvents {
    ...
    impl ::core::convert::From<PriceGuardedFilter> for UniswapAnchoredViewEvents {
        fn from(value: PriceGuardedFilter) -> Self {
            Self::PriceGuardedFilter(value)
        }
    }
    impl ::core::convert::From<PriceUpdatedFilter> for UniswapAnchoredViewEvents {
    ...
    #[derive(Clone, ::ethers::contract::EthAbiType, Debug, PartialEq, Eq, Hash)]
    pub enum UniswapAnchoredViewCalls {
    ...
    impl ::ethers::core::abi::AbiDecode for UniswapAnchoredViewCalls {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::AbiError> {
            let data = data.as_ref();
            if let Ok(decoded)
                = <EthBaseUnitCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::EthBaseUnit(decoded));
            }
            if let Ok(decoded)
                = <ExpScaleCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::ExpScale(decoded));
            }
            if let Ok(decoded)
                = <MaxIntegerCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::MaxInteger(decoded));
            }
            if let Ok(decoded)
                = <MaxTokensCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <ActivateFailoverCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::ActivateFailover(decoded));
            }
            if let Ok(decoded)
                = <AnchorPeriodCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::AnchorPeriod(decoded));
            }
            if let Ok(decoded)
                = <DeactivateFailoverCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::DeactivateFailover(decoded));
            }
            if let Ok(decoded)
                = <GetTokenConfigCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::GetTokenConfig(decoded));
            }
            if let Ok(decoded)
                = <GetTokenConfigByCTokenCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::GetTokenConfigByCToken(decoded));
            }
            if let Ok(decoded)
                = <GetTokenConfigByReporterCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::GetTokenConfigByReporter(decoded));
            }
            if let Ok(decoded)
                = <GetTokenConfigBySymbolCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::GetTokenConfigBySymbol(decoded));
            }
            if let Ok(decoded)
                = <GetTokenConfigBySymbolHashCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::GetTokenConfigBySymbolHash(decoded));
            }
            if let Ok(decoded)
                = <GetTokenConfigByUnderlyingCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::GetTokenConfigByUnderlying(decoded));
            }
            if let Ok(decoded)
                = <GetUnderlyingPriceCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::GetUnderlyingPrice(decoded));
            }
            if let Ok(decoded)
                = <LowerBoundAnchorRatioCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::LowerBoundAnchorRatio(decoded));
            }
            if let Ok(decoded)
                = <NumTokensCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <PokeFailedOverPriceCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
            ...
            if let Ok(decoded)
                = <UpperBoundAnchorRatioCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
    ...
    impl ::ethers::core::abi::AbiEncode for UniswapAnchoredViewCalls {
    ...
    impl ::core::fmt::Display for UniswapAnchoredViewCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<EthBaseUnitCall> for UniswapAnchoredViewCalls {
        fn from(value: EthBaseUnitCall) -> Self {
            Self::EthBaseUnit(value)
        }
    }
    impl ::core::convert::From<ExpScaleCall> for UniswapAnchoredViewCalls {
        fn from(value: ExpScaleCall) -> Self {
            Self::ExpScale(value)
        }
    }
    impl ::core::convert::From<MaxIntegerCall> for UniswapAnchoredViewCalls {
        fn from(value: MaxIntegerCall) -> Self {
            Self::MaxInteger(value)
        }
    }
    impl ::core::convert::From<MaxTokensCall> for UniswapAnchoredViewCalls {
        fn from(value: MaxTokensCall) -> Self {
            Self::MaxTokens(value)
        }
    }
    impl ::core::convert::From<AcceptOwnershipCall> for UniswapAnchoredViewCalls {
        fn from(value: AcceptOwnershipCall) -> Self {
            Self::AcceptOwnership(value)
        }
    }
    impl ::core::convert::From<ActivateFailoverCall> for UniswapAnchoredViewCalls {
        fn from(value: ActivateFailoverCall) -> Self {
            Self::ActivateFailover(value)
        }
    }
    impl ::core::convert::From<AnchorPeriodCall> for UniswapAnchoredViewCalls {
        fn from(value: AnchorPeriodCall) -> Self {
            Self::AnchorPeriod(value)
        }
    }
    impl ::core::convert::From<DeactivateFailoverCall> for UniswapAnchoredViewCalls {
        fn from(value: DeactivateFailoverCall) -> Self {
            Self::DeactivateFailover(value)
        }
    }
    impl ::core::convert::From<GetTokenConfigCall> for UniswapAnchoredViewCalls {
        fn from(value: GetTokenConfigCall) -> Self {
            Self::GetTokenConfig(value)
        }
    }
    impl ::core::convert::From<GetTokenConfigByCTokenCall> for UniswapAnchoredViewCalls {
    ...
    for UniswapAnchoredViewCalls {
        fn from(value: GetTokenConfigByReporterCall) -> Self {
            Self::GetTokenConfigByReporter(value)
        }
    }
    impl ::core::convert::From<GetTokenConfigBySymbolCall> for UniswapAnchoredViewCalls {
    ...
    impl ::core::convert::From<GetUnderlyingPriceCall> for UniswapAnchoredViewCalls {
        fn from(value: GetUnderlyingPriceCall) -> Self {
            Self::GetUnderlyingPrice(value)
        }
    }
    impl ::core::convert::From<LowerBoundAnchorRatioCall> for UniswapAnchoredViewCalls {
        fn from(value: LowerBoundAnchorRatioCall) -> Self {
            Self::LowerBoundAnchorRatio(value)
        }
    }
    impl ::core::convert::From<NumTokensCall> for UniswapAnchoredViewCalls {
        fn from(value: NumTokensCall) -> Self {
            Self::NumTokens(value)
        }
    }
    impl ::core::convert::From<OwnerCall> for UniswapAnchoredViewCalls {
        fn from(value: OwnerCall) -> Self {
            Self::Owner(value)
        }
    }
    impl ::core::convert::From<PokeFailedOverPriceCall> for UniswapAnchoredViewCalls {
        fn from(value: PokeFailedOverPriceCall) -> Self {
            Self::PokeFailedOverPrice(value)
        }
    }
    impl ::core::convert::From<PriceCall> for UniswapAnchoredViewCalls {
        fn from(value: PriceCall) -> Self {
            Self::Price(value)
        }
    }
    impl ::core::convert::From<PricesCall> for UniswapAnchoredViewCalls {
        fn from(value: PricesCall) -> Self {
            Self::Prices(value)
        }
    }
    impl ::core::convert::From<TransferOwnershipCall> for UniswapAnchoredViewCalls {
        fn from(value: TransferOwnershipCall) -> Self {
            Self::TransferOwnership(value)
        }
    }
    impl ::core::convert::From<UpperBoundAnchorRatioCall> for UniswapAnchoredViewCalls {
        fn from(value: UpperBoundAnchorRatioCall) -> Self {
            Self::UpperBoundAnchorRatio(value)
        }
    }
    impl ::core::convert::From<ValidateCall> for UniswapAnchoredViewCalls {
