...
pub mod comptroller {
    const _: () = {
        ::core::include_bytes!(
            "/home/joss/dev/liquidator/liquidator_v1/abi/comptroller.json",
        );
    };
    #[allow(deprecated)]
    ...
    impl ::ethers::core::abi::AbiDecode for ComptrollerCalls {
        fn decode(
            ...
            if let Ok(decoded) = <BackPopulateCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::BackPopulate(decoded));
            }
            if let Ok(decoded) = <BecomeCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::Become(decoded));
            }
            if let Ok(decoded) = <_BorrowGuardianPausedCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::_BorrowGuardianPaused(decoded));
            }
            if let Ok(decoded) = <GrantCompCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::GrantComp(decoded));
            }
            if let Ok(decoded) = <_MintGuardianPausedCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::_MintGuardianPaused(decoded));
            }
            if let Ok(decoded) = <SetBorrowCapGuardianCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SetBorrowCapGuardian(decoded));
            }
            if let Ok(decoded) = <SetBorrowPausedCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SetBorrowPaused(decoded));
            }
            if let Ok(decoded) = <SetCloseFactorCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SetCloseFactor(decoded));
            }
            if let Ok(decoded) = <SetCollateralFactorCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SetCollateralFactor(decoded));
            }
            if let Ok(decoded) = <SetCompSpeedsCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SetCompSpeeds(decoded));
            }
            if let Ok(decoded) = <SetContributorCompSpeedCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SetContributorCompSpeed(decoded));
            }
            if let Ok(decoded) = <SetLiquidationIncentiveCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SetLiquidationIncentive(decoded));
            }
            if let Ok(decoded) = <SetMarketBorrowCapsCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SetMarketBorrowCaps(decoded));
            }
            if let Ok(decoded) = <SetMintPausedCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SetMintPaused(decoded));
            }
            if let Ok(decoded) = <SetPauseGuardianCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SetPauseGuardian(decoded));
            }
            if let Ok(decoded) = <SetPriceOracleCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SetPriceOracle(decoded));
            }
            if let Ok(decoded) = <SetSeizePausedCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SetSeizePaused(decoded));
            }
            if let Ok(decoded) = <SetTransferPausedCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SetTransferPaused(decoded));
            }
            if let Ok(decoded) = <SupportMarketCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SupportMarket(decoded));
            }
            if let Ok(decoded) = <AccountAssetsCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <AllMarketsCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::AllMarkets(decoded));
            }
            if let Ok(decoded) = <BorrowAllowedCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::BorrowAllowed(decoded));
            }
            if let Ok(decoded) = <BorrowCapGuardianCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::BorrowCapGuardian(decoded));
            }
            if let Ok(decoded) = <BorrowCapsCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::BorrowCaps(decoded));
            }
            if let Ok(decoded) = <BorrowGuardianPausedCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::BorrowGuardianPaused(decoded));
            }
            if let Ok(decoded) = <BorrowVerifyCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::BorrowVerify(decoded));
            }
            if let Ok(decoded) = <CheckMembershipCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::CheckMembership(decoded));
            }
            if let Ok(decoded) = <ClaimCompWithCTokensCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::ClaimCompWithCTokens(decoded));
            }
            if let Ok(decoded) = <ClaimCompWithHoldersCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <CloseFactorMantissaCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::CloseFactorMantissa(decoded));
            }
            if let Ok(decoded) = <CompAccruedCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::CompAccrued(decoded));
            }
            if let Ok(decoded) = <CompBorrowSpeedsCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::CompBorrowSpeeds(decoded));
            }
            if let Ok(decoded) = <CompBorrowStateCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::CompBorrowState(decoded));
            }
            if let Ok(decoded) = <CompBorrowerIndexCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::CompBorrowerIndex(decoded));
            }
            if let Ok(decoded) = <CompContributorSpeedsCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::CompContributorSpeeds(decoded));
            }
            if let Ok(decoded) = <CompInitialIndexCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::CompInitialIndex(decoded));
            }
            if let Ok(decoded) = <CompRateCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::CompRate(decoded));
            }
            if let Ok(decoded) = <CompReceivableCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::CompReceivable(decoded));
            }
            if let Ok(decoded) = <CompSpeedsCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::CompSpeeds(decoded));
            }
            if let Ok(decoded) = <CompSupplierIndexCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::CompSupplierIndex(decoded));
            }
            if let Ok(decoded) = <CompSupplySpeedsCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::CompSupplySpeeds(decoded));
            }
            if let Ok(decoded) = <CompSupplyStateCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::CompSupplyState(decoded));
            }
            if let Ok(decoded) = <ComptrollerImplementationCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::ComptrollerImplementation(decoded));
            }
            if let Ok(decoded) = <EnterMarketsCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::EnterMarkets(decoded));
            }
            if let Ok(decoded) = <ExitMarketCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::ExitMarket(decoded));
            }
            if let Ok(decoded) = <FixBadAccrualsCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::FixBadAccruals(decoded));
            }
            if let Ok(decoded) = <GetAccountLiquidityCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::GetAccountLiquidity(decoded));
            }
            if let Ok(decoded) = <GetAllMarketsCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::GetAllMarkets(decoded));
            }
            if let Ok(decoded) = <GetAssetsInCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <GetCompAddressCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::GetCompAddress(decoded));
            }
            if let Ok(decoded) = <GetHypotheticalAccountLiquidityCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::GetHypotheticalAccountLiquidity(decoded));
            }
            if let Ok(decoded) = <IsComptrollerCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::IsComptroller(decoded));
            }
            if let Ok(decoded) = <IsDeprecatedCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::IsDeprecated(decoded));
            }
            if let Ok(decoded) = <LastContributorBlockCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::LastContributorBlock(decoded));
            }
            if let Ok(decoded) = <LiquidateBorrowAllowedCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::LiquidateBorrowAllowed(decoded));
            }
            if let Ok(decoded) = <LiquidateBorrowVerifyCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::LiquidateBorrowVerify(decoded));
            }
            if let Ok(decoded) = <LiquidateCalculateSeizeTokensCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::LiquidateCalculateSeizeTokens(decoded));
            }
            if let Ok(decoded) = <LiquidationIncentiveMantissaCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::LiquidationIncentiveMantissa(decoded));
            }
            if let Ok(decoded) = <MarketsCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::Markets(decoded));
            }
            if let Ok(decoded) = <MaxAssetsCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::MaxAssets(decoded));
            }
            if let Ok(decoded) = <MintAllowedCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::MintAllowed(decoded));
            }
            if let Ok(decoded) = <MintGuardianPausedCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::MintGuardianPaused(decoded));
            }
            if let Ok(decoded) = <MintVerifyCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <PauseGuardianCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
            ...
            if let Ok(decoded) = <PendingComptrollerImplementationCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::PendingComptrollerImplementation(decoded));
            }
            if let Ok(decoded) = <Proposal65FixExecutedCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::Proposal65FixExecuted(decoded));
            }
            if let Ok(decoded) = <RedeemAllowedCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::RedeemAllowed(decoded));
            }
            if let Ok(decoded) = <RedeemVerifyCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::RedeemVerify(decoded));
            }
            if let Ok(decoded) = <RepayBorrowAllowedCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::RepayBorrowAllowed(decoded));
            }
            if let Ok(decoded) = <RepayBorrowVerifyCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::RepayBorrowVerify(decoded));
            }
            if let Ok(decoded) = <SeizeAllowedCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SeizeAllowed(decoded));
            }
            if let Ok(decoded) = <SeizeGuardianPausedCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SeizeGuardianPaused(decoded));
            }
            if let Ok(decoded) = <SeizeVerifyCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::SeizeVerify(decoded));
            }
            if let Ok(decoded) = <TransferAllowedCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::TransferAllowed(decoded));
            }
            if let Ok(decoded) = <TransferGuardianPausedCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::TransferGuardianPaused(decoded));
            }
            if let Ok(decoded) = <TransferVerifyCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
                return Ok(Self::TransferVerify(decoded));
            }
            if let Ok(decoded) = <UpdateContributorRewardsCall as ::ethers::core::abi::AbiDecode>::decode(
                data,
            ) {
